...
class HttpAdapter constructor(val context: Context, val dataSet: List<BikeStation>) :
    Adapter<HttpAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        //요소들을 재배치한다.
        val bikeStation = dataSet[position]
        holder.title.text = bikeStation.stationName
    }
}
